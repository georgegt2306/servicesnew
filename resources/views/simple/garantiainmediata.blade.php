...
<div style="width:100%; height:60px; background-image:url(images/tituloGarantiaInmediata.png); background-size:contain; background-repeat:no-repeat; background-position:center"></div>
        ...
        <div class="centrar" style="width:625px">	
            <p class="textoGeneral">
        		Requisitos para productos SPEEDMIND vendidos por Electrónica Siglo 21:<br><br>
                <a class="noenlace">1.</a> Reclamo dentro de las 48 horas posterior a la fecha de despacho, previa comprobación del daño, el producto debe estar completo y debe cumplir con las condiciones del buen uso. <br><br>
